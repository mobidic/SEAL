...
v2s1 = Var2Sample(variant_ID=variant1.id, sample_ID=sample1.id, depth=20, allelic_depth=10, analyse1=0, analyse2=0, reported=0)
v2s2 = Var2Sample(variant_ID=variant2.id, sample_ID=sample1.id, depth=30, allelic_depth=20, analyse1=1, analyse2=1, reported=1)
v2s3 = Var2Sample(variant_ID=variant1.id, sample_ID=sample2.id, depth=45, allelic_depth=10, analyse1=1, analyse2=1, reported=0)
db.session.add(v2s1)
db.session.add(v2s2)
db.session.add(v2s3)
db.session.commit()
