...
variant3 = Variant(id="chr1-12-a-t", chr="chr1", pos=12, ref="a", alt="t")
db.session.add(variant1)
db.session.add(variant2)
db.session.add(variant3)

v1s1 = Var2Sample(variant_ID=variant1.id, sample_ID=sample1.id, depth=20, allelic_depth=10, analyse1=False, analyse2=False, reported=False)
v2s1 = Var2Sample(variant_ID=variant2.id, sample_ID=sample1.id, depth=30, allelic_depth=20, analyse1=True, analyse2=True, reported=True)
v3s1 = Var2Sample(variant_ID=variant3.id, sample_ID=sample1.id, depth=50, allelic_depth=49, analyse1=True, analyse2=False, reported=False)
v2s2 = Var2Sample(variant_ID=variant2.id, sample_ID=sample2.id, depth=45, allelic_depth=10, analyse1=True, analyse2=True, reported=False)
db.session.add(v1s1)
db.session.add(v2s1)
db.session.add(v3s1)
db.session.add(v2s2)
...
variant = Variant.query.get("chr1-12-a-t")
variant.annotations = [{
    "date": "aaa",
    "ANN": {
        "NM_0001": {
            ...
            "GenoCanyon_rankscore": "0.74766",
            "H1-hESC_fitCons_rankscore": "0.34648",
            "HGVSc": "NM_0001.7:c.12A>T",
            "HGVSg": "chr1:g.12A>T",
            "HGVSp": "ENSP00000326281.7:p.Ile12Thr",
            "HUVEC_fitCons_rankscore": "0.14980",
            "IMPACT": "MODERATE",
            "INTRON": None,
            "LINSIGHT_rankscore": None,
            ...
            "SpliceAI_pred_DS_AL": "0.25",
            "SpliceAI_pred_DS_DG": "0.55",
            "SpliceAI_pred_DS_DL": "0.85",
            "SpliceAI_pred_SYMBOL": "CAPN3",
            "VARIANT_CLASS": "SNV",
            "VEST4_rankscore": "0.93135",
            "bStatistic_converted_rankscore": "0.80015",
